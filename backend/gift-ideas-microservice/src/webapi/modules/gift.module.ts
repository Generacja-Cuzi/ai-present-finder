...
@Module({
  imports: [
    ...
    ClientsModule.register([
      createRabbitMQPublisher("FETCH_ALLEGRO_EVENT", "FetchAllegroEvent"),
      createRabbitMQPublisher("FETCH_AMAZON_EVENT", "FetchAmazonEvent"),
      createRabbitMQPublisher("FETCH_EBAY_EVENT", "FetchEbayEvent"),
      createRabbitMQPublisher("FETCH_OLX_EVENT", "FetchOlxEvent"),
      createRabbitMQPublisher(
        "GIFT_CONTEXT_INITIALIZED_EVENT",
