...
W dalszej części rozdziału umieszczono również fizyczny diagram bazy RestAPI (Rysunek~\ref{fig:db-restapi}) oraz schematy baz mikroserwisów Chat, Gift Ideas i Reranking (Rysunki~\ref{fig:er-chat}, \ref{fig:er-gift-ideas}, \ref{fig:er-reranking}).
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{../databases/restapi.pdf}
    \caption{Diagram fizyczny bazy danych mikroserwisu RestAPI.}
    \label{fig:db-restapi}
\end{figure}
\end{landscape}
